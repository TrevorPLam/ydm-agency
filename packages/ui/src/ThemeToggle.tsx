 ...
 * ARCHITECTURE: Client component using the useTheme hook from ./ThemeProvider; renders a button that toggles the theme and swaps Sun/Moon icons based on the current theme.
 ...
 * SIDE EFFECTS: Updates the global theme via ThemeProvider setTheme on click.
 * ASSUMES: A ThemeProvider from ./ThemeProvider is present in an ancestor component.
 */
