 ...
 * PURPOSE: Provides the complete CONVERSION_LESSONS array of EducationLesson objects for the Conversion topic in the /education section.
 ...
 * KEY RULES: Each lesson must conform to the EducationLesson interface; slugs must be unique within the Conversion topic; topic must be 'Conversion'; attribution and safety fields must be set per the content sourcing policy.
 * DEPENDS ON: ./types (EducationLesson).
 * LAST UPDATED: 2026-08-10 Merged conversion-lessons-new.ts into this canonical file.
 */
