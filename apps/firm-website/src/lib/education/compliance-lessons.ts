 ...
 * PURPOSE: Provides the complete COMPLIANCE_LESSONS array of EducationLesson objects for the Compliance topic in the /education section.
 ...
 * KEY RULES: Each lesson must conform to the EducationLesson interface; slugs must be unique within the Compliance topic; topic must be 'Compliance'; attribution and safety fields must be set per the content sourcing policy.
 * DEPENDS ON: ./types (EducationLesson).
 * LAST UPDATED: 2026-08-10 Merged compliance-lessons-new.ts into this canonical file.
 */
