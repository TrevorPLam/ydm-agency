/**
 * FILE: seo-lessons.ts
 * PURPOSE: Provides the complete SEO_LESSONS array of EducationLesson objects for the SEO topic in the /education section.
 ...
 * KEY RULES: Each lesson must conform to the EducationLesson interface; slugs must be unique within the SEO topic; topic must be 'SEO'; attribution and safety fields must be set per the content sourcing policy.
 * DEPENDS ON: ./types (EducationLesson).
 * LAST UPDATED: 2026-08-10 Merged seo-lessons-new.ts into this canonical file.
 */
